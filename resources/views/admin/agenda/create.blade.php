            ...
            <div class="card-body p-5">
                <form action="{{ url('admin/agenda') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <div class="row">
                        <div class="col"><label for="exampleInputUsername1" class="fw-bold">Ticket Name<span class="text-danger">*</span></label><input type="text" class="form-control" name="nama_tiket[]" placeholder="Input Name Ticket..." required></div>
                        <div class="col"><label for="exampleInputUsername1" class="fw-bold">Price Ticket<span class="text-danger">*</span></label><input type="text" class="form-control" name="harga_tiket[]" placeholder="Input Price Ticket..." required></div><div class="col-auto"><br>
