  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Create Dewan</h1>
      ...
      <form action="{{ url('admin/dewan') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ old('nama') }}" id="exampleInputUsername1" placeholder="Input Dewan Name..." name="nama">
                        @error('nama')
                ...
                <table class="table table-hover table-striped" id="table1">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th style="text-align: center;">Dewan</th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach($dewans as $item)
                    <tr class="fw-bold">
                        ...
                        <td >
                            <div class="d-flex justify-content-center gap-1">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="EditLabel">Edit Dewan</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                    <form action="{{ url('admin/dewan', $item->id) }}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        @method('PUT')
                                        <div class="form-group">
                                            <label for="exampleInputUsername1" class="fw-bold">Dewan<span class="text-danger">*</span></label>
                                ...
                                <form action="{{ url('admin/dewan', $item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="DetailLabel">Detail Dewan</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-4">Dewan: </div>
