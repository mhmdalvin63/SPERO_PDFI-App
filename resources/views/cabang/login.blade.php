...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <p class="auth-subtitle mb-5">Welcome to PDFI</p>

            <form method="POST" action="{{route('postlogin.cabang')}}">
            @csrf
            ...
            <div class="text-center mt-5 text-lg fs-4">
                <p class="text-gray-600">Don't have an account? <a href="/cabang/register" class="font-bold">Sign
                        up</a>.</p>
