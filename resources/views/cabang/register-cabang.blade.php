    ...
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            @if (session('error'))
              ...
              @endif
            <form method="POST" action="{{route('postregister.cabang')}}">
            @csrf
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" class="form-control form-control-xl" name="name" placeholder="Nama Ketua Cabang">
            ...
            <div class="text-center mt-5 text-lg fs-4">
                <p class='text-gray-600'>Already have an account? <a href="/cabang/login" class="font-bold">Log
                        in</a>.</p>
            </div>
        </div>
    </div>
